             ...
             , tabPanel("2. Generate Predictor Parameters",
                        ...
                        sidebarLayout(
                          sidebarPanel(h2("Assign Predictor Variables")
                                       ...
                                       # , uiOutput("UI_predictors_user_col_sampid")

                                       , h4("D. Run Operation")
                                       , p("This button will assign COMID based on Lat-Long and then predictors based on COMID")
