...
Upload the files (the order shouldn\'t matter) and select a single
common identifier from each file to perform the merge (e.g., SampleID).
The common identifier doesn\'t need to be named the same thing in both
files. Just click on the drop-down menus and the list of fields in your
input files will appear. Select the correct identifiers from each file.
