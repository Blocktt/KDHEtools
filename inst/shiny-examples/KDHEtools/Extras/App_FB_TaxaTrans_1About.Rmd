...
run again. If it\'s a legitimate taxon that isn\'t in the Taxa
Translator table, please email
...
<a href="https://github.com/Blocktt/ShinyAppDocuments/blob/main/KDHEtools/Example_Files/Test1_FileBuilder_TaxaAttr.csv/" target="_blank">here</a>.
