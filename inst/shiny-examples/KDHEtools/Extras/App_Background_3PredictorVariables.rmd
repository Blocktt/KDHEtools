...
A table with predictor variables (except for Longitude and CFS) for all NHDPlusV2 local catchments in Kansas can be downloaded <a href="https://github.com/Blocktt/KDHEtools/blob/main/inst/shiny-examples/KDHEtools/data/KS_StreamCat_PredictorTable_BenB_20230721.xlsx/" target="_blank">here</a>.

For more information, please read the Kansas Macroinvertebrate MMI <a href="https://github.com/Blocktt/ShinyAppDocuments/tree/main/KDHEtools/Reports/" target="_blank">report</a>.
