...
OTUs differ across calculations. For example, for the BCG model calculation, 
worms are collapsed to Subclass and mites to Order-level. For the thermal 
preference metric calculations, mites and worms are kept at the lowest practical
taxonomic level. 
...
2. Appends the Pacific Northwest taxa attributes, which include the Maritime 
Region BCG taxa attributes, functional feeding group and thermal preference 
assignments, and more.

The ‘taxa translator’ and attribute tables are based on stream biomonitoring 
data from Oregon and Washington and will be updated on an annual basis. If you 
have questions or comments about these tables, or want to request the addition 
of new taxa, please email Sean Sullivan (ssullivan@rhithron.com).
...
<!-- Click [here](links/Test1_FileBuilder_TaxaTransAttr.csv) to download a test file. -->
